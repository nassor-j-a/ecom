...
class ShippingForm(forms.ModelForm):
    ...
    shipping_addres1 = forms.CharField(label="", widget=forms.TextInput(
    ...
    class Meta:
        ...
        fields = ('shipping_full_name','shipping_email','shipping_addres1','shipping_address2','shipping_city','shipping_state','shipping_zipcode','shipping_country')
